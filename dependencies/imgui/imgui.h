...
namespace ImGui
{
	...
	IMGUI_API bool          ButtonDisabled(const char* label, const ImVec2& size_arg = ImVec2(0, 0));
	...
	IMGUI_API bool          RadioButton(const char* label, unsigned char* v, unsigned char v_button);

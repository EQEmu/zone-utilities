...
private:
    ...
    dtStatus
        GetPolyHeightNoConnections(const dtNavMeshQuery* query, dtPolyRef ref, const float* pos, float* height) const;
    dtStatus GetPolyHeightOnPath(const dtPolyRef* path,
                                 const int path_len,
                                 const glm::vec3& pos,
    ...
    void LoadNavMesh();
    void LoadVolumes();
    void AddMeshConnection(const glm::vec3& start,
                           const glm::vec3& end,
                           float radius,
                           unsigned char dir,
                           unsigned char area,

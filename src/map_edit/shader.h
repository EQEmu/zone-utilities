#ifndef EQEMU_MAP_EDIT_SHADER_H
#define EQEMU_MAP_EDIT_SHADER_H
...
public:
    ...
    inline void SetValue(unsigned int v, unsigned int v2, unsigned int v3, unsigned int v4) {
        glUniform4ui(location_id, v, v2, v3, v4);
    }
    ...
    inline void SetValueMatrix2(int count, bool transpose, float* v) {
        glUniformMatrix2fv(location_id, count, transpose, v);
    }
    inline void SetValueMatrix3(int count, bool transpose, float* v) {
        glUniformMatrix3fv(location_id, count, transpose, v);
    }
    inline void SetValueMatrix4(int count, bool transpose, float* v) {
        glUniformMatrix4fv(location_id, count, transpose, v);
    }
    inline void SetValueMatrix2x3(int count, bool transpose, float* v) {
        glUniformMatrix2x3fv(location_id, count, transpose, v);
    }
    inline void SetValueMatrix3x2(int count, bool transpose, float* v) {
        glUniformMatrix3x2fv(location_id, count, transpose, v);
    }
    inline void SetValueMatrix2x4(int count, bool transpose, float* v) {
        glUniformMatrix2x4fv(location_id, count, transpose, v);
    }
    inline void SetValueMatrix4x2(int count, bool transpose, float* v) {
        glUniformMatrix4x2fv(location_id, count, transpose, v);
    }
    inline void SetValueMatrix3x4(int count, bool transpose, float* v) {
        glUniformMatrix3x4fv(location_id, count, transpose, v);
    }
    inline void SetValueMatrix4x3(int count, bool transpose, float* v) {
        glUniformMatrix4x3fv(location_id, count, transpose, v);
    }
...
class ShaderProgram {
public:
    ShaderProgram(const std::string& vertex = "", const std::string& fragment = "", const std::string& geometry = "");
    ...
    ShaderUniform GetUniformLocation(const char* name);

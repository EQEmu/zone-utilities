...
EQEmu::S3D::WLDFragment03::WLDFragment03(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
...
EQEmu::S3D::WLDFragment04::WLDFragment04(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment05::WLDFragment05(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment10::WLDFragment10(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment11::WLDFragment11(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment12::WLDFragment12(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment13::WLDFragment13(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment14::WLDFragment14(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment15::WLDFragment15(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
    ...
    if(ref->id <= 0) {
        ...
        plac->SetRotation(
            header->rotate_x / 512.f * 360.f, header->rotate_y / 512.f * 360.f, header->rotate_z / 512.f * 360.f);
...
EQEmu::S3D::WLDFragment1B::WLDFragment1B(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment1C::WLDFragment1C(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment21::WLDFragment21(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment22::WLDFragment22(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment28::WLDFragment28(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment29::WLDFragment29(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment2D::WLDFragment2D(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment30::WLDFragment30(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
    ...
    try {
        ...
        *new_tb = *tb;
        ...
        if(header->params1 & (1 << 1) || header->params1 & (1 << 2) || header->params1 & (1 << 3) ||
           header->params1 & (1 << 4))
            new_tb->SetFlags(1);
        else
            new_tb->SetFlags(0);
...
EQEmu::S3D::WLDFragment31::WLDFragment31(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
...
EQEmu::S3D::WLDFragment36::WLDFragment36(std::vector<WLDFragment>& out,
                                         char* frag_buffer,
                                         uint32_t frag_length,
                                         uint32_t frag_name,
                                         char* hash,
    ...
    for(uint32_t i = 0; i < header->normal_count; ++i) {
        ...
        // this check is here cause there's literally zones where there's normals than verts (ssratemple for ex). Stupid
        // I know.
        if(i < model->GetVertices().size()) {

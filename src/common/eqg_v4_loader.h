...
namespace EQEmu {
    ...
    private:
        bool ParseZoneDat(EQEmu::PFS::pfs_archive& archive, std::shared_ptr<EQG::Terrain>& terrain);
        bool ParseWaterDat(EQEmu::PFS::pfs_archive& archive, std::shared_ptr<EQG::Terrain>& terrain);
        bool ParseInvwDat(EQEmu::PFS::pfs_archive& archive, std::shared_ptr<EQG::Terrain>& terrain);
